...
function Fe(i, {
    ...
    const o = getComputedStyle(i),
        ...
        [f, s] = o.transformOrigin.split(" ").map(parseFloat),
        l = e.left + e.width * f / t.width - (t.left + f),
        r = e.top + e.height * s / t.height - (t.top + s),
        {
            delay: c = 0,
    ...
    return {
        delay: c,
        duration: Ie(d) ? d(Math.sqrt(l * l + r * r)) : d,
        easing: v,
        css: (u, y) => {
            const p = y * l,
                b = y * r,
                z = u + y * e.width / t.width,
                L = u + y * e.height / t.height;
...
function Ve(i, e, t) {
    ...
    return i.$$set = l => {
        "icon" in l && t(0, n = l.icon), "borderColorVar" in l && t(1, o = l.borderColorVar), "size" in l && t(2, a = l.size), "padding" in l && t(3, f = l.padding), "background" in l && t(4, s = l.background)
    }, [n, o, a, f, s]
}
class Be extends R {
    constructor(e) {
        super(), I(this, e, Ve, Ge, M, {
            icon: 0,
            borderColorVar: 1,
            size: 2,
            padding: 3,
...
function ne(i) {
    let e, t, n, o, a = P[i[1].type].eventIcon + "",
        f, s, l, r = !i[1].id.includes("customNotification") && !i[1].id.includes("preflight"),
        c, d = i[1].type === "pending" && ie(),
        v = r && oe(i);
    return {
        c() {
            e = h("div"), d && d.c(), t = x(), n = h("div"), o = h("div"), l = x(), v && v.c(), m(o, "class", f = B(`notification-icon flex items-center justify-center ${i[1].type==="pending"?"pending-icon":""}`) + " svelte-jvic9v"), m(n, "class", "flex items-center justify-center border relative notification-icons-wrapper svelte-jvic9v"), m(n, "style", s = `background:${P[i[1].type].backgroundColor}; color: ${P[i[1].type].iconColor||""}; ${i[1].type==="pending"?"height: 28px; width: 28px; margin: 2px;":`border: 2px solid ${P[i[1].type].borderColor}`}; `), m(e, "class", "relative")
        },
        m(u, y) {
            _(u, e, y), d && d.m(e, null), g(e, t), g(e, n), g(n, o), o.innerHTML = a, g(e, l), v && v.m(e, null), c = !0
        },
        p(u, y) {
            u[1].type === "pending" ? d || (d = ie(), d.c(), d.m(e, t)) : d && (d.d(1), d = null), (!c || y & 2) && a !== (a = P[u[1].type].eventIcon + "") && (o.innerHTML = a), (!c || y & 2 && f !== (f = B(`notification-icon flex items-center justify-center ${u[1].type==="pending"?"pending-icon":""}`) + " svelte-jvic9v")) && m(o, "class", f), (!c || y & 2 && s !== (s = `background:${P[u[1].type].backgroundColor}; color: ${P[u[1].type].iconColor||""}; ${u[1].type==="pending"?"height: 28px; width: 28px; margin: 2px;":`border: 2px solid ${P[u[1].type].borderColor}`}; `)) && m(n, "style", s), y & 2 && (r = !u[1].id.includes("customNotification") && !u[1].id.includes("preflight")), r ? v ? (v.p(u, y), y & 2 && w(v, 1)) : (v = oe(u), v.c(), w(v, 1), v.m(e, null)) : v && (A(), T(v, 1, 1, () => {
                v = null
            }), G())
        },
        i(u) {
...
function oe(i) {
    ...
    return t = new Be({
        ...
        c() {
            e = h("div"), D(t.$$.fragment), m(e, "class", "absolute chain-icon-container svelte-jvic9v")
        },
        m(o, a) {
...
function Ke(i) {
    ...
    return {
        ...
        p(o, [a]) {
            o[1].type ? n ? (n.p(o, a), a & 2 && w(n, 1)) : (n = ne(o), n.c(), w(n, 1), n.m(e.parentNode, e)) : n && (A(), T(n, 1, 1, () => {
                n = null
            }), G())
        },
        i(o) {
...
function ae(i) {
    ...
    ago`), m(t, "class", "svelte-pm7idu")
        ...
        m(f, s) {
            _(f, e, s), _(f, t, s), g(t, o), _(f, a, s)
        },
        p(f, s) {
            s & 3 && n !== (n = f[2](f[1] - f[0]) + "") && q(o, n)
        },
        d(f) {
            f && C(e), f && C(t), f && C(a)
        }
...
function re(i) {
    ...
    return n = new Qe({
        ...
        c() {
            e = h("span"), s.c(), t = x(), D(n.$$.fragment), m(e, "class", "hash-time svelte-1otz6tt")
        },
        m(l, r) {
            _(l, e, r), s.m(e, null), g(e, t), H(n, e, null), o = !0
        },
        p(l, r) {
            f === (f = a(l)) && s ? s.p(l, r) : (s.d(1), s = f(l), s && (s.c(), s.m(e, t)));
            const c = {};
            r & 1 && (c.startTime = l[0].startTime), n.$set(c)
        },
        i(l) {
            o || (w(n.$$.fragment, l), o = !0)
        },
        o(l) {
            T(n.$$.fragment, l), o = !1
        },
...
function tt(i) {
    ...
    return {
        ...
        p(a, f) {
            f & 1 && t !== (t = K(a[0].id) + "") && q(n, t), f & 1 && o !== (o = a[0].link) && m(e, "href", o)
        },
        d(a) {
            a && C(e)
        }
...
function nt(i) {
    let e, t, n = i[0].message + "",
        o, a, f = i[0].id && !i[0].id.includes("customNotification") && !i[0].id.includes("preflight"),
        s, l = f && re(i);
    return {
        c() {
            e = h("div"), t = h("span"), o = E(n), a = x(), l && l.c(), m(t, "class", "transaction-status svelte-1otz6tt"), m(e, "class", "flex flex-column notify-transaction-data svelte-1otz6tt")
        },
        m(r, c) {
            _(r, e, c), g(e, t), g(t, o), g(e, a), l && l.m(e, null), s = !0
        },
        p(r, [c]) {
            (!s || c & 1) && n !== (n = r[0].message + "") && q(o, n), c & 1 && (f = r[0].id && !r[0].id.includes("customNotification") && !r[0].id.includes("preflight")), f ? l ? (l.p(r, c), c & 1 && w(l, 1)) : (l = re(r), l.c(), w(l, 1), l.m(e, null)) : l && (A(), T(l, 1, 1, () => {
                l = null
            }), G())
        },
        i(r) {
...
async function fe({
    ...
    const {
        ...
        gasPriceProbability: d
    } = Y.get().notify.replacement, {
        gas: v,
        apiKey: u
    } = Z, [y] = await v.get({
        chains: [W[r]],
        ...
        confidence: j
    }) => j === (i === "speedup" ? d.speedup : d.cancel)), z = ee(p), L = ee(b), k = o === "0x" ? {} : {
        data: o
    };
...
function de(i) {
    ...
    return {
        ...
        m(s, l) {
            _(s, e, l), g(e, t), g(e, n), g(e, o), a || (f = [S(t, "click", i[9]), S(o, "click", i[10])], a = !0)
        },
        p: N,
        d(s) {
            s && C(e), a = !1, he(f)
...
function ft(i) {
    let e, t, n, o, a, f, s, l, r, c, d, v, u, y;
    n = new Ye({
        props: {
            notification: i[0],
            chainStyles: U[W[i[0].network]]
        }
    }), a = new ot({
        props: {
            notification: i[0]
    ...
    return {
        c() {
            e = h("div"), t = h("div"), D(n.$$.fragment), o = x(), D(a.$$.fragment), f = x(), s = h("div"), l = h("div"), r = x(), c = h("div"), p && p.c(), m(l, "class", "flex items-center close-icon svelte-ftkynd"), m(s, "class", "notify-close-btn notify-close-btn-" + i[4].type + " pointer flex svelte-ftkynd"), m(t, "class", "flex bn-notify-notification-inner svelte-ftkynd"), m(c, "class", "dropdown svelte-ftkynd"), V(c, "dropdown-visible", i[2] && i[5] && le(i[0].eventCode) && se(i[0].network) && ce(i[7])), m(e, "class", d = "bn-notify-notification bn-notify-notification-" + i[0].type + "} svelte-ftkynd"), V(e, "bn-notify-clickable", i[0].onClick)
        },
        m(b, z) {
            _(b, e, z), g(e, t), H(n, t, null), g(t, o), H(a, t, null), g(t, f), g(t, s), g(s, l), l.innerHTML = at, g(e, r), g(e, c), p && p.m(c, null), v = !0, u || (y = [S(s, "click", be(i[8])), S(e, "mouseenter", i[11]), S(e, "mouseleave", i[12]), S(e, "click", i[13])], u = !0)
        },
        p(b, [z]) {
            const L = {};
            z & 1 && (L.notification = b[0]), z & 1 && (L.chainStyles = U[W[b[0].network]]), n.$set(L);
            const k = {};
            z & 1 && (k.notification = b[0]), a.$set(k), b[0].eventCode === "txPool" ? p ? p.p(b, z) : (p = de(b), p.c(), p.m(c, null)) : p && (p.d(1), p = null), (!v || z & 165) && V(c, "dropdown-visible", b[2] && b[5] && le(b[0].eventCode) && se(b[0].network) && ce(b[7])), (!v || z & 1 && d !== (d = "bn-notify-notification bn-notify-notification-" + b[0].type + "} svelte-ftkynd")) && m(e, "class", d), (!v || z & 1) && V(e, "bn-notify-clickable", b[0].onClick)
        },
        i(b) {
...
function dt(i, e, t) {
    ...
    let {
        ...
        updateParentOnRemove: l
    } = e, r, c = !1;
    const d = Oe.getValue().find(({
            hash: k
        }) => k === s.id),
        v = d && n.find(({
            accounts: k
            ...
            address: j
        }) => j.toLowerCase() === d.from.toLowerCase()));
    ke(() => {
        clearTimeout(r)
    });
    const u = () => {
        ...
        y = async () => {
            try {
                ...
                const j = `${d.hash.slice(0,9)}:txReplaceError${d.hash.slice(-5)}`;
                X({
                    id: j,
                    type: "hint",
                    eventCode: "txError",
        ...
        b = () => t(2, c = !0),
        z = () => t(2, c = !1),
        L = k => s.onClick && s.onClick(k);
    return i.$$set = k => {
        "notification" in k && t(0, s = k.notification), "updateParentOnRemove" in k && t(1, l = k.updateParentOnRemove)
    }, i.$$.update = () => {
        i.$$.dirty & 1 && s.autoDismiss && (r = setTimeout(() => {
            J(s.id), Q(s.id)
        }, s.autoDismiss))
    }, [s, l, c, o, a, f, d, v, u, y, p, b, z, L]
}
class ut extends R {
    constructor(e) {
        super(), I(this, e, dt, ft, M, {
            notification: 0,
...
function ve(i) {
    ...
    return {
        c() {
            ...
            m(e, "class", o = "bn-notify-" + i[0] + " " + i[5] + " svelte-1h8mmo3"), m(e, "style", a = `${i[0].includes("top")?"justify-content:flex-start;":""}; max-height: calc(100vh - ${i[6].expanded?"412px":i[1]&&i[7].type!=="mobile"?"82px":!i[1]&&i[7].type==="mobile"?"108px":"24px"})`)
        },
        m(r, c) {
            _(r, e, c);
        ...
        p(r, c) {
            if (c & 517) {
                ...
                t = Ce(t, c, l, 1, r, s, n, e, Ne, pe, null, ue);
                for (let d = 0; d < t.length; d += 1) t[d].a();
                G()
            }(!f || c & 33 && o !== (o = "bn-notify-" + r[0] + " " + r[5] + " svelte-1h8mmo3")) && m(e, "class", o), (!f || c & 67 && a !== (a = `${r[0].includes("top")?"justify-content:flex-start;":""}; max-height: calc(100vh - ${r[6].expanded?"412px":r[1]&&r[7].type!=="mobile"?"82px":!r[1]&&r[7].type==="mobile"?"108px":"24px"})`)) && m(e, "style", a)
        },
        i(r) {
            if (!f) {
                for (let c = 0; c < s.length; c += 1) w(t[c]);
                f = !0
            }
        },
        o(r) {
...
function pe(i, e) {
    ...
    return n = new ut({
        ...
        first: null,
        c() {
            t = h("li"), D(n.$$.fragment), o = x(), m(t, "class", a = B(`bn-notify-li-${e[0]} ${e[0].includes("top")?"notification-list-top":"notification-list-bottom"}`) + " svelte-1h8mmo3"), this.first = t
        },
        m(u, y) {
            _(u, t, y), H(n, t, null), g(t, o), c = !0, d || (v = S(t, "click", be(e[10])), d = !0)
        },
        p(u, y) {
            e = u;
            const p = {};
            y & 4 && (p.notification = e[12]), n.$set(p), (!c || y & 1 && a !== (a = B(`bn-notify-li-${e[0]} ${e[0].includes("top")?"notification-list-top":"notification-list-bottom"}`) + " svelte-1h8mmo3")) && m(t, "class", a)
        },
        r() {
        ...
        o(u) {
            T(n.$$.fragment, u), f && f.invalidate(), s = Se(t, Re, {
                duration: 300,
                easing: ye
            }), c = !1
        },
        d(u) {
            u && C(t), F(n), u && s && s.end(), d = !1, v()
        }
    }
}
...
function pt(i) {
    ...
    return {
        ...
        p(o, [a]) {
            o[2].length ? n ? (n.p(o, a), a & 4 && w(n, 1)) : (n = ve(o), n.c(), w(n, 1), n.m(e.parentNode, e)) : n && (A(), T(n, 1, 1, () => {
                n = null
            }), G())
        },
        i(o) {
...
function bt(i, e, t) {
    ...
    const {
        device: o
    } = Z, a = Y.select("accountCenter").pipe(_e(Y.get().accountCenter), we(1));
    $(i, a, p => t(6, n = p));
    let {
        position: f
    } = e, {
    ...
    let d = "y-scroll";
    const v = () => {
            d !== "y-visible" && t(5, d = "y-visible"), u(function() {
                t(5, d = "y-scroll")
            }, 1e3)
        },
        u = function() {
    ...
    return i.$$set = p => {
        "position" in p && t(0, f = p.position), "sharedContainer" in p && t(1, s = p.sharedContainer), "notifications" in p && t(2, l = p.notifications)
    }, i.$$.update = () => {
        i.$$.dirty & 1 && (f.includes("top") ? t(4, c = -50) : t(4, c = 50))
    }, [f, s, l, r, c, d, n, o, a, v, y]
}
class ht extends R {
    constructor(e) {
        super(), I(this, e, bt, pt, M, {
            position: 0,
            sharedContainer: 1,
            notifications: 2
        }, vt)
